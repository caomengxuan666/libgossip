...
版本说明见 [CHANGELOG.md](CHANGELOG.md)，发布检查清单见
[RELEASE.md](RELEASE.md)，引用元数据见 [CITATION.cff](CITATION.cff)。
...
4. 生成覆盖率报告：
   ```bash
   ninja coverage_report  # 对于 Ninja 构建
   # 或
   ninja test_and_coverage
    # 或
   make coverage_report   # 对于 Make 构建
   # 或
